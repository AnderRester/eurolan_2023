var typing = new Typed('.text_title_add', {
    strings: ['', 'TRAVEL <span>/ VISA</span>'],
    typeSpeed: 60,
});

var typing = setTimeout(() => {
    new Typed('.text_header_add', {
...
var typing = setTimeout(() => {
    new Typed('.text_info_header_add', {
        strings: ['', 'We encourage and welcome delegates from around the globe to take part in Eurolan 2023.'],
        typeSpeed: 20,
    });
}, 2800);

var typing = setTimeout(() => {
    new Typed('.text_info_add', {
        strings: [
            '',
